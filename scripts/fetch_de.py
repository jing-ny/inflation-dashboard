...
SERIES_ID = "DEUCPIALLMINMEI"  # Germany CPI All Items (Monthly, 2015=100)


def fetch_de_cpi_series(months=13):
    """Fetch Germany CPI data from FRED API"""
    if not FRED_API_KEY:
