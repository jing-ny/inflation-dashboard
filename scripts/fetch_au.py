...
SERIES_ID = "AUSCPIALLQINMEI"  # Australia CPI All Items (Quarterly)


def fetch_au_cpi_series(quarters=5):
    """Fetch Australia CPI data from FRED API (quarterly)"""
    if not FRED_API_KEY:
